    ...
    return (
        ...
        <div class="bg-blue-200 max-w-screen-2xl flex flex-col justify-between  px-4 overflow-hidden lg:flex-row">
            <div class="w-full pl-12 mr-4 text-left lg:w-1/4 sm:text-center sm:pl-0 lg:text-left">
                <p class="mt-6 mr-4 text-base text-gray-500">travelmate
                </p>
                <p class="mt-6 mr-4 text-base text-gray-500">Travelmate brings you the places to visit in Dhaka as well as the places to visit in Bangladesh.</p>
            </div>
              ...
              <a href="/" title="" class="block flex items-center opacity-75 hover:opacity-100">
                ...
                <div className="bg-blue-300">
                    <div className="max-w-screen-xl mx-auto py-4 px-5 flex flex-wrap flex-col justify-center sm:flex-row">
                        <p className="text-gray-600 text-sm text-center sm:text-left">© 2021 Developed by —
                            <a href="https://github.com/shorifzaman" rel="noopener noreferrer" className="text-blue-600 ml-1" target="_blank">@Zaman</a>
                        </p>
                    </div>
                </div>
      </footer>
