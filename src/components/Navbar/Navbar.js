...
const navigation = [
    ...
    return (
      <>
        <header className={changeHeader ? "fixed z-50 top-0 left-0 w-full shadow-md transition duration-500" : " bg-gradient-to-r from-emerald-400 to-dark-500 fixed z-50 top-0 left-0 w-full transition duration-500"}>
                 ...
                 {user.displayName ? (
                    <>
                        <div className="flex items-center justify-end space-x-3">
                            ...
                            <Link to="/manage"> <p className="text-gray-700 poppins hidden md:block lg:block">{user.displayName}</p></Link>
                            {/* <p className="text-gray-700 poppins hidden md:block lg:block">{user.displayName}</p> */}
                            <FiLogOut className="cursor-pointer w-6 h-6 text-gray-700" onClick={logout} />
                        </div>
                    ...
                    <>
                        <div className="flex items-center justify-end space-x-2">
                            <button className="poppins text-slate-200" onClick={() => history.push('/signin')}>Sign In</button>
              ...
              >
                <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                  <div className="px-5 pt-4 flex items-center justify-between">
                    ...
                    <div className="-mr-2">
                      <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-dark hover:text-emerald-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-emerald-500">
                ...
                <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                 {navigation.map((item) => (
                    <a key={item.name} href={item.href} className="font-medium text-white hover:text-emerald-500">
                      {item.name}
                    </a>
                  ))}
